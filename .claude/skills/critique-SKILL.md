...
**Cognitive Load** (consult [cognitive-load](critique--cognitive-load.md)):
...
**Nielsen's Heuristics** (consult [heuristics-scoring](critique--heuristics-scoring.md)):
...
#### Design Health Score
> *Consult [heuristics-scoring](critique--heuristics-scoring.md)*
...
For each issue, tag with **P0-P3 severity** (consult [heuristics-scoring](critique--heuristics-scoring.md) for severity definitions):
...
#### Persona Red Flags
> *Consult [personas](critique--personas.md)*
