...
## Date: 2026-04-20 | v4.0.0 | 117 skills + 1 protocol | Single source of truth
...
|------|----|------------|---------|-------------|
| planning/planning--reconnaissance-gate-SKILL.md | SK-529 | 0 | v2.0.0 | Evidence before synthesis; STATE.recon; XIIGen Tier-0 search list (8 files + 2 greps); thresholds by session type |
...
Not skills (no SK number). Loaded by skills or consulted directly.
...
Layer 8  — Governance discipline (11 skills, SK-529..SK-539):          COMPLETE ← NEW v4.0.0
           SK-529 v2.0.0 — Tier-0 XIIGen search list
