...
license: Apache 2.0. Based on Anthropic's frontend-design skill. See THIRD_PARTY_NOTICES.md at the repository root for attribution.
---
...
### Typography
→ *Consult [typography reference](impeccable--typography.md) for OpenType features, web font loading, and the deeper material on scales.*
...
### Color & Theme
→ *Consult [color reference](impeccable--color-and-contrast.md) for the deeper material on contrast, accessibility, and palette construction.*
...
### Layout & Space
→ *Consult [spatial reference](impeccable--spatial-design.md) for the deeper material on grids, container queries, and optical adjustments.*
...
### Motion
→ *Consult [motion reference](impeccable--motion-design.md) for timing, easing, and reduced motion.*
...
### Interaction
→ *Consult [interaction reference](impeccable--interaction-design.md) for forms, focus, and loading patterns.*
...
### Responsive
→ *Consult [responsive reference](impeccable--responsive-design.md) for mobile-first, fluid design, and container queries.*
...
### UX Writing
→ *Consult [ux-writing reference](impeccable--ux-writing.md) for labels, errors, and empty states.*
...
If this skill is invoked with the argument "craft" (e.g., `/impeccable craft [feature description]`), follow the [craft flow](impeccable--craft.md). Pass any additional arguments as the feature description.
...
If this skill is invoked with the argument "extract" (e.g., `/impeccable extract [target]`), follow the [extract flow](impeccable--extract.md). Pass any additional arguments as the extraction target.