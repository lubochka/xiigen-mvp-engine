# PATCH: xiigen-core-principles-SKILL.md — Add M1-M5 (Mission Layer) + P17-P22
## Applies to: planning--xiigen-core-principles-SKILL.md
## Version: v2.0.0 | Date: 2026-03-25
## Source: XIIGen Skills Overhaul — Session 1 (governing prompt analysis)
...
Add M1 through M5 BEFORE P1 — at the very top of the principles list, as the
governing context from which all P-principles derive their purpose.
Label the section: `## MISSION PRINCIPLES (governing layer — all P-principles serve these)`
...
Codebase AGENTS.md acknowledgment of P17-P22 is a separate update (S6 of overhaul).
