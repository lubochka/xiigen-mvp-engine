# PATCH: FREEDOM config — Judge Model and Generator Model Selection
## Applies to: reference--freedom-config-schema.md + fabrics.module.ts
## Version: v2.0.0 | Date: 2026-03-25
## Source: XIIGen Skills Overhaul — Session 1
## Locked decision: D-EXT-009
