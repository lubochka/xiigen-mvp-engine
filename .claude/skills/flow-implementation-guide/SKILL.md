...
description: >
  ...
  v1.2 adds Step 3.b (TypeScript service file classification with @connectionType)
  and V9 (portability gate with P-1..P-5 checks). Closes G-33.
author: luba
updated: "2026-04-23"
priority: SUPREME
triggers:
...
# Flow Implementation Guide Skill v1.2
...
4. dna-compliance-guard v1.1.0          ← 9 DNA rules + P-1..P-5 portability checks
5. xiigen-core-principles               ← P1-P8 compliance check
6. plan-review-skill                    ← FC-1 through FC-15 consistency
```
...
### STEP 3.b: CLASSIFY TYPESCRIPT SERVICE FILES — NEW v1.2.0
...
### STEP 7: VALIDATE (9 dimensions after every phase)

After each phase, run ALL 9 validation checks. V9 is new in v1.2.
...
#### V9: PORTABILITY GATE — NEW v1.2.0
