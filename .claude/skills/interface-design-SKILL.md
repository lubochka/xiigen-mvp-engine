...
- `interface-design--principles.md` — Code examples, specific values, dark mode
- `interface-design--validation.md` — Memory management, when to update system.md
- `interface-design--critique.md` — Post-build craft critique protocol
