...
version: "5.0.0"
description: >
  Master orchestration skill for preparing plans that Claude Code can execute.
  9-step pipeline. 11 principles (P1-P11). FC-1 through FC-21.
  D-STACK decisions govern stack coupling. SK-430/431/432 run as steps 8-9.
  Naming conventions enforced throughout. FLOW-00.1 and FLOW-00.2 are
  prerequisites for FLOW-01+.
author: luba
updated: "2026-03-22"
priority: SUPREME
triggers:
