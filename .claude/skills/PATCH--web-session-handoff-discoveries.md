# PATCH: web-session-handoff-SKILL.md — discoveries[] + rejected_claims[]
## Applies to: session-output--web-session-handoff-SKILL.md
## Version: v1.0.3 | Date: 2026-03-24
## Source: XIIGEN-SKILLS-GAP-DOCUMENT.md — EDIT 6

---

## HOW TO APPLY

Insert the two sections below between "WHAT PHASE BUILT" and "OPEN ITEMS"
in the handoff schema.
