# PATCH: infrastructure-discovery-SKILL.md — Step 0.5 + Step 1.5
## Applies to: pipeline--infrastructure-discovery-SKILL.md
## Version: v1.0.3 | Date: 2026-03-24
## Source: XIIGEN-SKILLS-GAP-DOCUMENT.md — EDIT 7

---

## HOW TO APPLY

Insert Step 0.5 between existing Step 0 (pre-existing failure audit) and Step 1 (artifact boundaries).
Insert Step 1.5 after existing Step 1 (live artifact boundaries).
