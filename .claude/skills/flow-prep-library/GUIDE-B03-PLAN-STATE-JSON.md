...
|-----------|--------------------|------------------------------------|
| STEP-1 (INVARIANTS) | `cycle1.status → "INVARIANTS_EXTRACTED"`, `step_status → "COMPLETE"` | `cycle1.status`, `current_step → 1`, `step_status → "COMPLETE"`, add `FLOW-XX-STEP-1-INVARIANTS.md` to `documents_produced` |
