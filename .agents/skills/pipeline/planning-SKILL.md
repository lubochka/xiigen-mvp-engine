...
**Run infrastructure-discovery (**infrastructure-discovery**) first.** This gate is the gate check that discovery completed.
...
Every plan must explicitly answer all 8 questions from `xiigen-core-principles-skill` (**xiigen-core-principles**). Any "no" requires either:
