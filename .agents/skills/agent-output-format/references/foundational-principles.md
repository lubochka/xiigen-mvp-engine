...
This is a new gate in the planning workflow — **Gate 7** (Foundational Principles
check, between Gate 6 "Canonical Doc Sync" and the plan-review-skill SESSION-0).
...
planning-skill (8 gates)
  ...
  └── Gate 7: Foundational Principles (8 checks) ← THIS GATE

plan-review-skill (12 FCs + 3 gates)
  └── SESSION-0: FC-1 through FC-12 (includes Principles Compliance)
```
