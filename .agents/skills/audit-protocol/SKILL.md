...
Point 7 ("Gate thresholds — no ~approximately") is expressed in this MVP's own tooling.
A gate threshold is concrete only when it is a count or comparison in NestJS/React tooling:
