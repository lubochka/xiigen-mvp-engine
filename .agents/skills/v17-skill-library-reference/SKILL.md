...
| Skill | Directory | Description | Node.js Alt |
|-------|-----------|-------------|------------|
| 06 | `06-ai-providers` | Codex, OpenAI, Gemini, DeepSeek implementations of IAiProvider with retry | `alternatives/nodejs/ai-providers.ts` |
...
| 35 | `35-mcp-server` | MCP server for AI API access via Codex tools protocol | `alternatives/nodejs/mcp-server-service.ts` |
...
| File | Purpose |
|------|---------|
| `AGENTS.md` | Commands, DNA rules, quick reference — READ THIS IN EVERY SESSION |
