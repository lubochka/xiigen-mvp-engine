# FLOW-33 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `SystemInitiationBootstrapPage.tsx` | `/admin/system-initiation-bootstrap/system-initiation-bootstrap` | `page-system-initiation-bootstrap` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | FLOW-33 has no documented states — topology and product spec both missing, and no parseabl… | `SystemInitiationBootstrapPage.tsx` | `page-systeminitiationbootstrap` |
