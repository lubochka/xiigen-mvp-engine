# FLOW-31 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `DesignIntelligenceEnginePage.tsx` | `/admin/design-intelligence-engine/design-intelligence-engine` | `page-design-intelligence-engine` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | FLOW-31 has no documented states — topology and product spec both missing, and no parseabl… | `DesignIntelligenceEnginePage.tsx` | `page-designintelligenceengine` |
