# FLOW-31 QA Run Report — Phase 13
...
- `client/e2e/design-intelligence-engine-crud.spec.ts`
- `client/e2e/design-intelligence-engine-mock-states.spec.ts`

## Snapshots

| # | File | Size (KB) | Visual OK |
|--:|------|----------:|:---------:|
| 1 | `c-03-before.png` | 43.8 | ✅ |
| 2 | `crud-after-create.png` | 43.8 | ✅ |
| 3 | `crud-initial-load.png` | 43.8 | ✅ |
| 4 | `crud-list-with-test-row.png` | 47.0 | ✅ |
| 5 | `default.png` | 43.8 | ✅ |
| 6 | `state-1-flow-has.png` | 33.7 | ✅ |
...
npx playwright test client/e2e/design-intelligence-engine*.spec.ts --reporter=list

# 3) Verify PNGs
ls -la docs/e2e-snapshots/design-intelligence-engine/
find docs/e2e-snapshots/design-intelligence-engine/ -name '*.png' -size -1k  # expect no output
