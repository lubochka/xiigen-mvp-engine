# FLOW-30 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `TenantLifecycleManagerPage.tsx` | `/admin/tenant-lifecycle-manager/tenant-lifecycle-manager` | `page-tenant-lifecycle-manager` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | FLOW-30 has no documented states — topology and product spec both missing, and no parseabl… | `TenantLifecycleManagerPage.tsx` | `page-tenantlifecyclemanager` |
