# FLOW-40 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `ClientPushPage.tsx` | `/admin/client-push/client-push` | `page-client-push` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | Client Push Infrastructure-specific patterns TBD | `ClientPushPage.tsx` | `page-clientpush` |
