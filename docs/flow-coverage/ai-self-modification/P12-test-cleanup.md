# FLOW-44 Test Coverage Cleanup — Phase 12
...
|--------|------|------:|------:|----------:|------:|----------:|------------:|
| client/e2e | `client/e2e/ai-self-modification-crud.spec.ts` | 98 | 2 | 0 | 0 | 0 | 0 |
| client/e2e | `client/e2e/ai-self-modification-mock-states.spec.ts` | 36 | 0 | 0 | 0 | 0 | 0 |
...
- **Test gate:** `npx jest ai-self-modification --no-coverage` → failures === 0 required. Server jest baseline ≥ 10,617.
