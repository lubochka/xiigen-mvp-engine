# FLOW-00 Test Coverage Cleanup — Phase 12
...
|--------|------|------:|------:|----------:|------:|----------:|------------:|
| client/e2e | `client/e2e/bundle-activation-crud.spec.ts` | 98 | 2 | 0 | 0 | 0 | 0 |
| client/e2e | `client/e2e/bundle-activation-mock-states.spec.ts` | 90 | 0 | 0 | 0 | 0 | 0 |
...
- **Test gate:** `npx jest bundle-activation --no-coverage` → failures === 0 required. Server jest baseline ≥ 10,617.
