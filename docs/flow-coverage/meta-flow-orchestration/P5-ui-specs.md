# FLOW-43 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `MetaFlowOrchestrationPage.tsx` | `/admin/meta-flow-orchestration/meta-flow-orchestration` | `page-meta-flow-orchestration` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | Session Management-specific patterns TBD | `MetaFlowOrchestrationPage.tsx` | `page-metafloworchestration` |
