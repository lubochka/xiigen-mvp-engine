# FLOW-19 UI Automation Gap Analysis — Phase 3 Deliverable
...
No `*.spec.ts` found matching `durable-sagas-compliance` in either `client/e2e/` or `e2e/tests/`.

| # | Business State | P2 Verdict | Automation | Spec File | Test | Line |
|---|---------------|------------|-----------|-----------|------|------|
| 1 | Every task type in T287-T306 has at least one plan step | COVERED | NOT_TESTED | `—` | — | — |
...
| 6 | Focus areas covered: 9 named check evaluators, EP-5 crash harness | COVERED | NOT_TESTED | `—` | — | — |
