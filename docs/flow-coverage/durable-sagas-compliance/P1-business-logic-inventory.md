# FLOW-19 Business Logic Inventory — Phase 1 Deliverable

**Flow:** Durable Sagas & Compliance (`durable-sagas-compliance`)
**Classification:** ADMIN_FACING
**Source:** SIMULATION
**Source document:** simulation file `docs\sessions\FLOW-19\FLOW-19-STEP-1-INVARIANTS.md`
...
6. Focus areas covered: 9 named check evaluators, EP-5 crash harness
