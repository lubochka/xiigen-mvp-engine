# FLOW-35 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `MetaArbitrationEnginePage.tsx` | `/admin/meta-arbitration-engine/meta-arbitration-engine` | `page-meta-arbitration-engine` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | FLOW-35 has no documented states — topology and product spec both missing, and no parseabl… | `MetaArbitrationEnginePage.tsx` | `page-metaarbitrationengine` |
