# FLOW-22 Business Logic Inventory — Phase 1 Deliverable

**Flow:** CMS Publishing (`cms-publishing`)
**Classification:** TENANT_FACING
**Source:** SIMULATION
**Source document:** simulation file `docs\sessions\FLOW-22\FLOW-22-STEP-1-INVARIANTS.md`
...
1. Every task type in T341-T380 has at least one plan step
...
6. Focus areas covered: CMS editorial workflow, versioned publishing, slug registry
