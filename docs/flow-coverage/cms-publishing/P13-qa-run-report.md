# FLOW-22 QA Run Report — Phase 13
...
- `client/e2e/cms-publishing-crud.spec.ts`
- `client/e2e/cms-publishing-mock-states.spec.ts`
- `client/e2e/cms-publishing.spec.ts`

## Snapshots

| # | File | Size (KB) | Visual OK |
|--:|------|----------:|:---------:|
| 1 | `01-every-task-type-in-t341-t380-has-at-leas.png` | 43.2 | ✅ |
...
| 9 | `crud-list-with-test-row.png` | 46.2 | ✅ |
| 10 | `default.png` | 43.2 | ✅ |
| 11 | `state-1-every-task.png` | 32.5 | ✅ |
| 12 | `state-2-every-plan.png` | 33.0 | ✅ |
| 13 | `state-3-no-step.png` | 32.4 | ✅ |
| 14 | `state-4-no-step-2.png` | 31.8 | ✅ |
| 15 | `state-5-all-steps.png` | 31.8 | ✅ |
| 16 | `state-6-focus-areas.png` | 33.4 | ✅ |
...
npx playwright test client/e2e/cms-publishing*.spec.ts --reporter=list

# 3) Verify PNGs
ls -la docs/e2e-snapshots/cms-publishing/
find docs/e2e-snapshots/cms-publishing/ -name '*.png' -size -1k  # expect no output
