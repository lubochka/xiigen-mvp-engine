# FLOW-27 Test Coverage Cleanup — Phase 12
...
|--------|------|------:|------:|----------:|------:|----------:|------------:|
| client/e2e | `client/e2e/human-interaction-gate-crud.spec.ts` | 98 | 2 | 0 | 0 | 0 | 0 |
| client/e2e | `client/e2e/human-interaction-gate-mock-states.spec.ts` | 84 | 0 | 0 | 0 | 0 | 0 |
...
- **Test gate:** `npx jest human-interaction-gate --no-coverage` → failures === 0 required. Server jest baseline ≥ 10,617.
