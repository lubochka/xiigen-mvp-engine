# FLOW-47 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `ModuleLifecyclePage.tsx` | `/admin/module-lifecycle/module-lifecycle` | `page-module-lifecycle` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | FLOW-47 has no documented states — topology and product spec both missing, and no parseabl… | `ModuleLifecyclePage.tsx` | `page-modulelifecycle` |
