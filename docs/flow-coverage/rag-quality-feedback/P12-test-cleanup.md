# FLOW-38 Test Coverage Cleanup — Phase 12
...
|--------|------|------:|------:|----------:|------:|----------:|------------:|
| client/e2e | `client/e2e/rag-quality-feedback-crud.spec.ts` | 98 | 2 | 0 | 0 | 0 | 0 |
| client/e2e | `client/e2e/rag-quality-feedback-mock-states.spec.ts` | 36 | 0 | 0 | 0 | 0 | 0 |
...
- **Test gate:** `npx jest rag-quality-feedback --no-coverage` → failures === 0 required. Server jest baseline ≥ 10,617.
