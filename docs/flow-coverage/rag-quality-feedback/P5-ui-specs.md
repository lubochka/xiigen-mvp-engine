# FLOW-38 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `RagQualityFeedbackPage.tsx` | `/admin/rag-quality-feedback/rag-quality-feedback` | `page-rag-quality-feedback` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | Learning Loop — RAG Quality Feedback-specific patterns TBD | `RagQualityFeedbackPage.tsx` | `page-ragqualityfeedback` |
