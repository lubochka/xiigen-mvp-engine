# FLOW-39 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `OssCurriculumPage.tsx` | `/admin/oss-curriculum/oss-curriculum` | `page-oss-curriculum` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | Local Model Curriculum — OSS Teaching Pipeline-specific patterns TBD | `OssCurriculumPage.tsx` | `page-osscurriculum` |
