# FLOW-39 QA Run Report — Phase 13
...
- `client/e2e/oss-curriculum-crud.spec.ts`
- `client/e2e/oss-curriculum-mock-states.spec.ts`
- `client/e2e/oss-curriculum.spec.ts`

## Snapshots

| # | File | Size (KB) | Visual OK |
|--:|------|----------:|:---------:|
| 1 | `c-03-before.png` | 42.9 | ✅ |
| 2 | `crud-after-create.png` | 42.9 | ✅ |
| 3 | `crud-initial-load.png` | 42.9 | ✅ |
| 4 | `crud-list-with-test-row.png` | 46.0 | ✅ |
| 5 | `default.png` | 46.0 | ✅ |
| 6 | `state-1-local-model.png` | 32.4 | ✅ |
...
npx playwright test client/e2e/oss-curriculum*.spec.ts --reporter=list

# 3) Verify PNGs
ls -la docs/e2e-snapshots/oss-curriculum/
find docs/e2e-snapshots/oss-curriculum/ -name '*.png' -size -1k  # expect no output
