# FLOW-14 UI Gap Analysis — Phase 2 Deliverable
...
|------|-------------------|--------------|
| `EtlDataIntegrationPage.tsx` | YES | 366 |
...
|---|---------------|-----------|----------|
| 1 | Every task type in T189-T200 has at least one plan step | COVERED | 1/1 pages routed |
...
| 6 | Focus areas covered: ETL pipeline, 25 CloudEvent schemas, BFA peer-flow rules | COVERED | 1/1 pages routed |
