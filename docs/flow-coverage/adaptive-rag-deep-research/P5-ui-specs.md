# FLOW-29 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `AdaptiveRagDeepResearchPage.tsx` | `/admin/adaptive-rag-deep-research/adaptive-rag-deep-research` | `page-adaptive-rag-deep-research` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | FLOW-29 has no documented states — topology and product spec both missing, and no parseabl… | `AdaptiveRagDeepResearchPage.tsx` | `page-adaptiveragdeepresearch` |
