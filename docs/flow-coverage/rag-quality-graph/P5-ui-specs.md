# FLOW-42 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `RagQualityGraphPage.tsx` | `/admin/rag-quality-graph/rag-quality-graph` | `page-rag-quality-graph` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | Learning Handoff-specific patterns TBD | `RagQualityGraphPage.tsx` | `page-ragqualitygraph` |
