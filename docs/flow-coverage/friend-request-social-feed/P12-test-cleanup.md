# FLOW-07 Test Coverage Cleanup — Phase 12
...
|--------|------|------:|------:|----------:|------:|----------:|------------:|
| server/test | `server/test/e2e/friend-request-social-feed/friend-request-social-feed-proper-flow.e2e.spec.ts` | 421 | 0 | 0 | 0 | 0 | 0 |
| server/test | `server/test/e2e/friend-request-social-feed/friend-request-social-feed.e2e.spec.ts` | 1051 | 0 | 0 | 0 | 0 | 0 |
...
- **Test gate:** `npx jest friend-request-social-feed --no-coverage` → failures === 0 required. Server jest baseline ≥ 10,617.
