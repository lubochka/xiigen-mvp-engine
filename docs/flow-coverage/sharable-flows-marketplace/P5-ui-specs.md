# FLOW-32 UI Spec — Phase 5 Deliverable
...
|------|---------------|--------------------|
| `SharableFlowsMarketplacePage.tsx` | `/admin/sharable-flows-marketplace/sharable-flows-marketplace` | `page-sharable-flows-marketplace` |

## Per-State UI Assignment

| # | Business State | Target Page | Data-testid Hook |
|---|---------------|-------------|------------------|
| 1 | FLOW-32 has no documented states — topology and product spec both missing, and no parseabl… | `SharableFlowsMarketplacePage.tsx` | `page-sharableflowsmarketplace` |
