# FLOW-24 UI Gap Analysis — Phase 2 Deliverable
...
|------|-------------------|--------------|
| `AiSafetyModerationPage.tsx` | YES | 369 |
...
|---|---------------|-----------|----------|
| 1 | Every task type in T421-T460 has at least one plan step | COVERED | 1/1 pages routed |
...
| 6 | Focus areas covered: CF-465 IRON RULE, SafetyGateToken, 8 named checks, gamification ledger | COVERED | 1/1 pages routed |
