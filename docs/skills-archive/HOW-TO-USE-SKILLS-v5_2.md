...
## Version: v5.2 | Date: 2026-03-20
## Changes from v5.1:
##   - Execution order updated: added FEATURE-REGISTRY-S1 and FLOW-36
##   - Project files list updated: added FLOW-36-REFERENCE-PLAN-v2.md, FEATURE-REGISTRY-S1-PLAN.md
##   - Added Scenario 8: planning FEATURE-REGISTRY-S1 or FLOW-36
##   - Document quick-lookup: added contracts/features/ location
##   - FLOW-34 note: now runs after FLOW-36 (feature-aware)
...
FOR PLANNING (web sessions — you + Claude):
  ...
  FEATURE-REGISTRY-S1-PLAN-v2.md       ← Addendum v2.0: schema v2.0 + xiigen self-scan
  FLOW-36-REFERENCE-PLAN-v2.md         ← Feature Registry flow: 6 phases

  Execution visibility + parallel execution (new — 2026-03-20):
  FLOW-EXECUTION-VISIBILITY-PLAN.md    ← FLOW-01..24 gate templates + testing
  PARALLEL-EXECUTION-PLAN.md           ← wave execution model
  FLOW-00-REFERENCE-PLAN-v1.md         ← Bundle Activation flow
...
FOR DECISION-MAKING (any session — know what to check):
  ...
  SKILL-REGISTRATION-MANIFEST.md           ← wire SK-416–425 into FLOW-35 Phase A
...
FLOW-0A (master plan sessions 1-12)
  ...
  → FLOW-31 → FLOW-33 (v3)   ← engine runs uninterrupted
  → FEATURE-REGISTRY-S1      ← addendum: 2 phases, schema v2.0 + xiigen self-scan
  → FLOW-35 (v2)             ← meta-arbitration engine
  ...
  → FLOW-03..24 (Wave 2+ parallel after FLOW-02 ACTIVE)
```
