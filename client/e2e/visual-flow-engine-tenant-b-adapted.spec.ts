/**
 * FLOW-18 Tenant B adapted cascade screenshots.
 *
 * Captures the visual-flow canvas role matrix for Northwind's adapted
 * visual governance package.
 */
...
test.describe('FLOW-18 Tenant B adapted package', () => {
  ...
  for (const role of ROLES) {
    test(`${role} adapted canvas branch renders`, async ({ page }) => {
