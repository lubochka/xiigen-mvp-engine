/**
 * FLOW-18 Visual Flow Engine role matrix.
 *
 * Captures the visual-flow canvas route for the phase-0 role map across the
...
test.describe('FLOW-18 visual-flow-engine role matrix', () => {
  ...
  for (const role of ROLES) {
    test(`${role} canvas branch renders`, async ({ page }) => {
