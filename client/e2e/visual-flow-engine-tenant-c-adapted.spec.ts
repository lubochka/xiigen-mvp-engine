/**
 * FLOW-18 Tenant C adapted cascade screenshots.
 *
 * Captures the visual-flow canvas role matrix for Tessera's adapted
 * visual federation package.
 */
...
test.describe('FLOW-18 Tenant C adapted package', () => {
