/**
 * event-attendance-topology-qa.spec.ts — Phase 6 Topology Visual QA (REAL TOPOLOGY)
 *
 * TVQ-01..TVQ-08 for FLOW-04 — REPLACED 2026-04-17 (Track B batch).
 *
 * Source of truth: contracts/topologies/event-attendance.topology.json
 * (5 nodes, 4 edges incl. 0 terminal `to:null` markers).
 *
...
const FLOW_ID         = 'FLOW-04';
const SLUG            = 'event-attendance';
...
//   NODE_COUNT       = 5
//   EDGE_COUNT_RAW   = 4     (0 terminal-to-null filtered)
//   Source           = contracts/topologies/event-attendance.topology.json
void EDGE_COUNT;
void TERMINAL_COUNT;
