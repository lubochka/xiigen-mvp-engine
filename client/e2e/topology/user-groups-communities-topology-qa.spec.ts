/**
 * user-groups-communities-topology-qa.spec.ts — Phase 6 Topology Visual QA (REAL TOPOLOGY)
 *
 * TVQ-01..TVQ-08 for FLOW-06 — REPLACED 2026-04-17 (Track B batch).
 *
 * Source of truth: contracts/topologies/user-groups-communities.topology.json
 * (4 nodes, 7 edges incl. 0 terminal `to:null` markers).
 *
...
const FLOW_ID         = 'FLOW-06';
const SLUG            = 'user-groups-communities';
...
//   NODE_COUNT       = 4
//   EDGE_COUNT_RAW   = 7     (0 terminal-to-null filtered)
//   Source           = contracts/topologies/user-groups-communities.topology.json
void EDGE_COUNT;
void TERMINAL_COUNT;
