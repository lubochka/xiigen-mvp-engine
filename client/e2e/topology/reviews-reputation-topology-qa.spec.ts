/**
 * reviews-reputation-topology-qa.spec.ts — Phase 6 Topology Visual QA (REAL TOPOLOGY)
 *
 * TVQ-01..TVQ-08 for FLOW-10 — REPLACED 2026-04-17 (Track B batch).
 *
 * Source of truth: contracts/topologies/reviews-reputation.topology.json
 * (4 nodes, 8 edges incl. 0 terminal `to:null` markers).
 *
...
//   NODE_COUNT       = 4
//   EDGE_COUNT_RAW   = 8     (0 terminal-to-null filtered)
//   Source           = contracts/topologies/reviews-reputation.topology.json
void EDGE_COUNT;
void TERMINAL_COUNT;
