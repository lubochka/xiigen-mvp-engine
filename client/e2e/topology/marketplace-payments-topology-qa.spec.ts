/**
 * marketplace-payments-topology-qa.spec.ts — Phase 6 Topology Visual QA (REAL TOPOLOGY)
 *
 * TVQ-01..TVQ-09 for FLOW-16.
 *
 * Source of truth: contracts/topologies/marketplace-payments.topology.json
...
const FLOW_ID         = 'FLOW-16';
const SLUG            = 'marketplace-payments';
