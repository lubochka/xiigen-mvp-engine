/**
 * user-registration-topology-qa.spec.ts — Phase 6 Topology Visual QA (REAL TOPOLOGY)
 *
 * TVQ-01..TVQ-08 for FLOW-01 — REPLACED 2026-04-17.
 *
 * Track B REPLACE: source of truth is contracts/topologies/user-registration.topology.json
 * (3 nodes T47/T48/T49, 5 edges incl. 3 terminal `to:null` markers).
 *
...
const FLOW_ID         = 'FLOW-01';
const SLUG            = 'user-registration';
...
//   NODE_COUNT      = 3      (T47/T48/T49)
//   EDGE_COUNT      = 2      (T47→T48, T48→T49 — terminal-to-null filtered)
//   TERMINAL_COUNT  = 3      (registration-failed, email-verification-expired, onboarding-completed)
//   Source          = contracts/topologies/user-registration.topology.json
void EDGE_COUNT;
void TERMINAL_COUNT;
