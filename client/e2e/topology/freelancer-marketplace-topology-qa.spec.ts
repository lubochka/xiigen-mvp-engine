/**
 * freelancer-marketplace-topology-qa.spec.ts — Phase 6 Topology Visual QA (REAL TOPOLOGY)
 *
 * TVQ-01..TVQ-09 for FLOW-17.
 *
 * Source of truth: contracts/topologies/freelancer-marketplace.topology.json
...
const FLOW_ID         = 'FLOW-17';
const SLUG            = 'freelancer-marketplace';
