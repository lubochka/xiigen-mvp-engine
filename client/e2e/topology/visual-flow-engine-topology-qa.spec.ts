/**
 * visual-flow-engine-topology-qa.spec.ts — Phase 6 Topology Visual QA (REAL TOPOLOGY)
 *
 * TVQ-01..TVQ-09 for FLOW-18.
 *
 * Source of truth: contracts/topologies/visual-flow-engine.topology.json
...
const FLOW_ID         = 'FLOW-18';
const SLUG            = 'visual-flow-engine';
