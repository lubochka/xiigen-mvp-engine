/**
 * FLOW-18 Tenant C installed-from-B cascade screenshots.
 *
 * Captures the visual-flow canvas role matrix for the Tessera install of
 * Northwind's adapted visual governance package.
 */
...
test.describe('FLOW-18 Tenant C installed from Tenant B', () => {
  ...
  for (const role of ROLES) {
    test(`${role} installed-from-B canvas branch renders`, async ({ page }) => {
