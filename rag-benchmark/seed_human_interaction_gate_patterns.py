"""
FLOW-27 Pattern Seeder — seeds FLOW-27 design decisions into Elasticsearch and nano-graphrag.
"""
...
DESIGN_REASONING_FILE = DESIGN_REASONING_DIR / 'human-interaction-gate-design-decisions.json'
