"""
FLOW-26 Pattern Seeder — seeds FLOW-26 design decisions into Elasticsearch and nano-graphrag.
"""
...
DESIGN_REASONING_FILE = DESIGN_REASONING_DIR / 'meta-flow-engine-design-decisions.json'
